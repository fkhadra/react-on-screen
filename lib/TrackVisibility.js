  ...
  function TrackVisibility(props) {
    ...
    _this.isComponentVisible = function () {
      setTimeout(function () {
        ...
        var windowWidth = _this.props.body ? document.getElementById(_this.props.body)[0].clientWidth : window.innerWidth || html.clientWidth;
        var windowHeight = _this.props.body ? document.getElementById(_this.props.body)[0].clientWidth : window.innerHeight || html.clientHeight;
