...
function (_PureComponent) {
  ...
  function TrackVisibility(props) {
    ...
    _this.isFocused = function () {
      return _this.props.withFocus ? document.hasFocus() : true;
    };
    ...
    _this.isComponentVisible = function () {
      setTimeout(function () {
        ...
        var isVisible = _this.isVisible(boundingClientRect, windowWidth, windowHeight) && _this.isFocused();
    ...
    _this.throttleCbFocus = function () {
      console.log("From focus");

      _this.isComponentVisible();
    };

    _this.withFocus = false;
...
TrackVisibility.propTypes = {
   ...
   * 
   */
  withFocus: _propTypes["default"].bool
};
